...
// // Заполняет выбор в select из БД по запросу cypherCode
...
// // Меняет DOM блока "добавить вершину" в зависимости от того, какой тип вершины там выбран, получает
// // свойства типа вершины из БД. При выборе нового типа есть возможность выбрать наследование, чтобы поль-
// // зоваться свойствами других типов
...
// // Выводит список вершин при наборе текста
...
// // Обрабатывает клик по елементу в списке поиска
...
//             // document.getElementById('nodeSelect').value = i
//             // document.getElementById('nodeSelect').dispatchEvent(new MouseEvent('change'))
//             // document.getElementById('relationshipStart').value = 
...
// // Пользователь получает право делать CYPHER запросы
...
// // Вносит выбранную вершину в поле Изменить/Удалить вершину
...
//                 // console.log(record.get("p.description"))
//                 // console.log(record.get("p.title"))
//                 // console.log(record.get("p.topic"))
//                 // console.log(record.get("p.use").join(", "))

//                 //document.getElementById("relationshipStart").value = record.get("p.title")
